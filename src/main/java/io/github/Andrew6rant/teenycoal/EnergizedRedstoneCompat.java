...
public class EnergizedRedstoneCompat {
    ...
    public static final TeenyRedstoneTorch TEENY_ENERGIZED_REDSTONE_TORCH = new TeenyEnergizedRedstoneTorch(FabricBlockSettings.of(Material.DECORATION).nonOpaque().noCollision().luminance(10));
    public static final TeenyRedstoneWallTorch TEENY_ENERGIZED_REDSTONE_WALL_TORCH = new TeenyEnergizedRedstoneWallTorch(FabricBlockSettings.of(Material.DECORATION).nonOpaque().noCollision().luminance(10));
