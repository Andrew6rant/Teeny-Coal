...
public class TeenyWallTorch extends WallTorchBlock {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView view, BlockPos pos, ShapeContext context) {
        ...
        if(direction.equals(Direction.NORTH)) {
            return VoxelShapes.cuboid(0.34375f, 0.1875f, 0.75f, 0.65625f, 0.5625f, 1f);
        } else if (direction.equals(Direction.SOUTH)) {
            return VoxelShapes.cuboid(0.34375f, 0.1875f, 0f, 0.65625f, 0.5625f, 0.25f);
        } else if (direction.equals(Direction.EAST)) {
            return VoxelShapes.cuboid(0f, 0.1875f, 0.34375f, 0.25f, 0.5625f, 0.65625f);
        } else if (direction.equals(Direction.WEST)) {
            return VoxelShapes.cuboid(0.75f, 0.1875f, 0.34375f, 1f, 0.5625f, 0.65625f);
        } else {
            return VoxelShapes.cuboid(0.375f, 0f, 0.375f, 0.625f, 0.375f, 0.625f);
            // This should never be called, but just in case, it defaults to the default Teeny Torch cuboid
        }
    }
}
